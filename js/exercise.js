...
$(function() {
   ...
   var list2=[
       {name:'RC女士春季防透湿型冲锋衣',price:'329.00'},
       {name:'OG UNI-KNIT 训练鞋（男士）',price:'279.00'},
       {name:'正品林丹羽毛球服同款运动服',price:'269.00'},
       {name:'耐克男鞋跑步鞋登月ZOOM',price:'339.00'}
   ];
   str='';
   for(var i=0;i<list2.length;i++){
       str+='<div class="list_img"><a href="buy.html"><img src="./imgs/d'+(i+1)+'.jpg" alt="图片'+(i+1)+'"></a><span>'+list2[i].name+'"</span><br/><span>&yen;'+list2[i].price+'</span><a href="carts.html" class="buy"><span class="tooltiptext">加入购物车</span><img src="imgs/购物车2.png"></a></div>';
   }
   $("#list_1").append(str);
});
