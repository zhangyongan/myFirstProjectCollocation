...
$(function() {
   ...
   var list2=[
       {name:'通用休闲多功能长钱包',price:'219.00'},
       {name:'女款真皮双肩包 HT1056',price:'229.00'},
       {name:'女装真皮手提包 HT1110',price:'389.00'},
       {name:'男士皮带真皮平滑扣板扣',price:'589.00'}
   ];
   str='';
   for(var i=0;i<list2.length;i++){
       str+='<div class="list_img"><a href="buy.html"><img src="./imgs/e'+(i+1)+'.jpg" alt="图片'+(i+1)+'"></a><span>'+list2[i].name+'"</span><br/><span>&yen;'+list2[i].price+'</span><a href="carts.html" class="buy"><span class="tooltiptext">加入购物车</span><img src="imgs/购物车2.png"></a></div>';
   }
   $("#list_1").append(str);
});
