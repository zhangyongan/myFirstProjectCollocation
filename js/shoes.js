...
$(function() {
   ...
   var list2=[
       {name:'电绣高跟女鞋 CM171',price:'129.00'},
       {name:'波西米亚粗跟女鞋 CM207',price:'229.00'},
       {name:'时尚高帮休闲鞋（男女同款）',price:'159.00'},
       {name:'绒面高跟鞋女细跟春夏',price:'149.00'}
   ];
   str='';
   for(var i=0;i<list2.length;i++){
       str+='<div class="list_img"><a href="buy.html"><img src="./imgs/c'+(i+1)+'.jpg" alt="图片'+(i+1)+'"></a><span>'+list2[i].name+'</span><br/><span>&yen;'+list2[i].price+'</span><a href="carts.html" class="buy"><span class="tooltiptext">加入购物车</span><img src="imgs/购物车2.png"></a></div>';
   }
   $("#list_1").append(str);
});
